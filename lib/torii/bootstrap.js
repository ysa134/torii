...
import FacebookOauth2Endpoint from 'torii/endpoints/facebook-oauth2';
...
import TwitterEndpoint from 'torii/endpoints/twitter-oauth1';
...
export default function(container){
  ...
  container.register('torii-endpoint:-oauth1', Oauth1Endpoint);
  container.register('torii-endpoint:facebook-connect', FacebookConnectEndpoint);
  container.register('torii-endpoint:facebook-oauth2', FacebookOauth2Endpoint);
  ...
  container.register('torii-endpoint:twitter', TwitterEndpoint);
